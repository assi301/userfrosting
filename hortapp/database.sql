...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2015 a las 09:18:11
...
--
-- Base de datos: 'hortapp'
--
CREATE DATABASE IF NOT EXISTS hortapp DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE hortapp;
...
--
-- Creación: 23-03-2015 a las 09:53:32
--
...
--
-- Base de datos: 'hortapp_template'
--
CREATE DATABASE IF NOT EXISTS hortapp_template DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE hortapp_template;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'afectada'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS afectada;
...
--
-- Volcado de datos para la tabla 'afectada'
--
...
--
-- Estructura de tabla para la tabla 'img_bancal'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS img_bancal;
...
--
-- Estructura de tabla para la tabla 'img_plaga'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS img_plaga;
...
--
-- Volcado de datos para la tabla 'img_plaga'
--
...
--
-- Estructura de tabla para la tabla 'img_planta'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS img_planta;
...
--
-- Volcado de datos para la tabla 'img_planta'
--
...
--
-- Volcado de datos para la tabla 'remei'
--
...
--
-- Estructura de tabla para la tabla 'tasca_fixa'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS tasca_fixa;
...
--
-- Volcado de datos para la tabla 'tasca_fixa'
--
...
--
-- Estructura de tabla para la tabla 'tasca_planta'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS tasca_planta;
...
--
-- Volcado de datos para la tabla 'tasca_planta'
--
...
--
-- Estructura de tabla para la tabla 'tasca_remei'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS tasca_remei;
...
--
-- Volcado de datos para la tabla 'tasca_remei'
--
...
--
-- Estructura de tabla para la tabla 'tractada'
--
-- Creación: 23-03-2015 a las 09:55:50
--

DROP TABLE IF EXISTS tractada;
...
--
-- Volcado de datos para la tabla 'tractada'
--
...
--
-- Filtros para la tabla afectada
--
...
--
-- Filtros para la tabla img_bancal
--
...
--
-- Filtros para la tabla img_plaga
--
...
--
-- Filtros para la tabla img_planta
--
...
--
-- Filtros para la tabla tasca_fixa
--
...
--
-- Filtros para la tabla tasca_planta
--
...
--
-- Filtros para la tabla tasca_remei
--
...
--
-- Filtros para la tabla tractada
--
...
--
-- Base de datos: 'hortapp_user'
--
CREATE DATABASE IF NOT EXISTS hortapp_user DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE hortapp_user;
...
-- Estructura de tabla para la tabla 'afectada'
--
-- Creación: 23-03-2015 a las 09:56:24
--
...
-- Estructura de tabla para la tabla 'remei'
--
-- Creación: 23-03-2015 a las 09:56:25
--
