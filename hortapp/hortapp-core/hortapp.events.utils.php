...
class Event {
	...
	//applink extra parameters
	public $id; // integer
	public $detalls; // string
	public $parcela; // integer (parcela identifier)
	public $realitzada; // boolean
	...
	public function toArray() {
		...
		/*
		DEPRECATED. all events are allDay events! time is never used!
		...
		*/
		...
		$array['start'] = $this->start->format('Y-m-d');
		...
		$array['id'] = $this->id;
		$array['detalls'] = $this->detalls;
		$array['parcela'] = $this->parcela;		
		$array['realitzada'] = $this->realitzada;
		return $array;
	}
